...
best, best_loss = run_style_transfer(M,content_path,
                                     style_path,init_path,content_seg_path,style_seg_path, num_iterations=3000,content_weight=1e8,style_weight=0.001,tv_weight=1e-2,affine_weight=8e11)